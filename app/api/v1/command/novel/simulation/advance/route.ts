...
import { advanceNovelSimulation, createNovelGameSceneState, createNovelGameVisualProfile, validateNovelSimulationRun } from "@/lib/engine";
...
export async function POST(request: Request) {
  try {
    ...
    const nextRun = advanceNovelSimulation(record.project, run);
