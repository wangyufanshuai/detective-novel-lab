...
import { compareNovelSimulationBranch, createNovelGameSceneState, createNovelGameVisualProfile, rewindNovelSimulation, validateNovelSimulationRun } from "@/lib/engine";
...
export async function POST(request: Request) {
  try {
    ...
    let nextRun = rewindNovelSimulation(effectiveProject, run);
